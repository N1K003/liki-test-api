...
namespace Liki.TestApi.AppConfiguration
{
    public static class StartupSwaggerExtensions
    {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc(
                    ...
                    new Info
                    {
                        Version = "1.0",
                        Title = "Liki Test API",
                        Description = "Liki Test API developer documentation",
                        Contact = contact
                    });
        ...
        public static IApplicationBuilder UseSwaggerAndConfigure(this IApplicationBuilder applicationBuilder)
        {
            ...
            {
                c.DocumentTitle = "Liki Test API documentation";
                c.SwaggerEndpoint("/swagger/TestApi/swagger.json", "Liki Test API");
